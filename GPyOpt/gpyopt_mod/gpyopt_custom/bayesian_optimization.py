...
from .acquisition_optimizer import AcquisitionOptimizerWithPrecomputedSpace

import warnings
warnings.filterwarnings("ignore")

random_design_type = "random_w_precomputed_space"
...
class BayesianOptimization(BO):
    ...
    def __init__(self, f, domain = None, constraints = None, cost_withGradients = None, model_type = 'GP', X = None, Y = None,
        ...
        if "precomputed_space" in kwargs:
            self.precomputed_space = kwargs["precomputed_space"]
        ...
        self.acquisition_optimizer = AcquisitionOptimizerWithPrecomputedSpace(self.space, self.precomputed_space, self.acquisition_optimizer_type, )  ## more arguments may come here
